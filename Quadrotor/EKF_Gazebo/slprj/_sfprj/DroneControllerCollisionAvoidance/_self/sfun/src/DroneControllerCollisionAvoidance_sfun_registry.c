...
{
  extern unsigned int
    sf_DroneControllerCollisionAvoidance_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  extern unsigned int sf_sharedTrackingLibrary_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_DroneControllerCollisionAvoidance_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
...
{
  extern unsigned int sf_DroneControllerCollisionAvoidance_autoinheritance_info(
  ...
  if (strcmp(machineName, "DroneControllerCollisionAvoidance") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_DroneControllerCollisionAvoidance_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_DroneControllerCollisionAvoidance_third_party_uses_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "DroneControllerCollisionAvoidance") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_DroneControllerCollisionAvoidance_third_party_uses_info(nlhs,plhs,
      3,newRhs);
  }
...
{
  extern unsigned int sf_DroneControllerCollisionAvoidance_jit_fallback_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "DroneControllerCollisionAvoidance") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_DroneControllerCollisionAvoidance_jit_fallback_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_DroneControllerCollisionAvoidance_updateBuildInfo_args_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "DroneControllerCollisionAvoidance") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_DroneControllerCollisionAvoidance_updateBuildInfo_args_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_DroneControllerCollisionAvoidance_get_eml_resolved_functions_info( int
    nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  ...
  if (strcmp(machineName, "DroneControllerCollisionAvoidance") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_DroneControllerCollisionAvoidance_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_DroneControllerCollisionAvoidance_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"DroneControllerCollisionAvoidance")) {
    return(sf_DroneControllerCollisionAvoidance_method_dispatcher(simstructPtr,
...
extern void DroneControllerCollisionAvoidance_terminator(void);
...
void sf_machine_global_terminator(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 0) {
    DroneControllerCollisionAvoidance_terminator();
...
extern void DroneControllerCollisionAvoidance_initializer(void);
extern void sharedTrackingLibrary_initializer(void);
extern void DroneControllerCollisionAvoidance_register_exported_symbols
  (SimStruct* S);
extern void sharedTrackingLibrary_register_exported_symbols(SimStruct* S);
extern void DroneControllerCollisionAvoidance_debug_initialize(struct
...
{
  DroneControllerCollisionAvoidance_register_exported_symbols(S);
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      DroneControllerCollisionAvoidance_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    DroneControllerCollisionAvoidance_initializer();
    if (!simModeIsRTWGen) {
